...
class PayKind
{ // base class - no member variables
public:
...
ostream& operator<<(ostream& out, const PerCourse& pc)
{
	out << "Fee per Course:\t\t" << pc.getfeePerCourse() << endl;
...
class Employee : public UMLPerson
{ // derived class
public:
	// constructors and destructor
...
class NTT : public Faculty, public Salaried
{ // derived class
public:
	// constructors and destructor
